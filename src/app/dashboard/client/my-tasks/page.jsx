...
export default function MyTasksPage() {
    ...
    const limit = 10;
    const totalPages = Math.ceil(visibleTasks.length / limit) || 1;
    const paginatedTasks = visibleTasks.slice((currentPage - 1) * limit, currentPage * limit);
            ...
            <div className="dash-page-container">
                ...
                {!loading && !error && visibleTasks.length > 0 && (
                    <div style={{
                        ...
                        <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.2)', fontFamily: 'monospace', letterSpacing: '0.05em', margin: 0 }}>
